...
const Stories = ({ story: { title, news, img } }) => {
  const splideOtions = {
    perPage: 4,
    perMov: 1,
    type: "loop",
          ...
          <Splide options={splideOtions}>
            {news?.map((val, i) => (
              <SplideSlide key={i} className="mb-0.5">
                <div className="relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-state-200 ring-1 ring-slate-200">
                  ...
                  <div className="grid items-center justify-items-start px-4">
                    ...
                    <p className="text-sm text-justify lg:text-sx">
